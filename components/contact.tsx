      ...
      <div className="mx-auto max-w-6xl px-6 py-24 md:px-8 md:py-32">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <a
            ...
            className="group flex items-center gap-3 px-6 py-3 rounded-full border border-border bg-card/50 hover:bg-card hover:border-accent transition-all text-sm font-medium"
          >
            <div className="flex items-center justify-center p-2 rounded-full bg-accent/10 group-hover:bg-accent/20 transition-colors">
          ...
          <div className="space-y-12">
            <div>
              ...
              <a
                ...
                className="text-3xl font-bold hover:text-accent transition-colors block break-all"
              >
                {personalInfo.email}
              </a>
            </div>

            {/* <div className="p-8 rounded-3xl border border-border bg-background/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 text-base text-muted-foreground font-mono">
                <span className="size-3 rounded-full bg-green-500 animate-pulse" />
                Ready to work • {personalInfo.location}
              </div>
            </div> */}
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 p-4 rounded-2xl border border-border bg-card hover:border-accent hover:text-accent transition-all"
              >
